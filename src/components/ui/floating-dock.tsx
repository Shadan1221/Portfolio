  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      <button
        ...
        className="h-10 w-10 rounded-full bg-neutral-800 flex items-center justify-center border border-neutral-800"
      >
  ...
  return (
    <Link href={href} onClick={(e) => handleSmoothScroll(e, href)}>
      <motion.div
        ...
        className="aspect-square rounded-full bg-neutral-800/80 border border-white/10 flex items-center justify-center relative"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
